...
export const DEMO_SOS_CONTACTS = [
  { id: 'c1', name: 'Priya (Wife)',   phone: '9999999999' },
  { id: 'c2', name: 'Dr. Sharma',    phone: '8888888888' },
];

export function seedDemoData() {
  if (typeof window === 'undefined') return;
  localStorage.setItem('demo_medicines',    JSON.stringify(DEMO_MEDICINES));
...
export function getDemoMedicines()   { return JSON.parse(localStorage.getItem('demo_medicines')    || '[]'); }
...
export function getDemoSOSContacts() { return JSON.parse(localStorage.getItem('demo_sos_contacts') || '[]'); }
