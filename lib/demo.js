...
export const DEMO_JOURNAL = [
  { id: 'j1', date: new Date(Date.now() - 86400000).toISOString().split('T')[0], bp: '120/80', glucose: 98,  weight: 72.0, mood: { icon: 'mood_great', label: 'Great', value: 5, color: '#10B981' }, notes: 'Feeling good today!' },
  { id: 'j2', date: new Date(Date.now() - 2*86400000).toISOString().split('T')[0], bp: '118/78', glucose: 104, weight: 72.2, mood: { icon: 'mood_ok',    label: 'Okay',  value: 3, color: '#F59E0B' }, notes: 'Slight headache in the evening.' },
  { id: 'j3', date: new Date(Date.now() - 4*86400000).toISOString().split('T')[0], bp: '122/82', glucose: 96,  weight: 71.8, mood: { icon: 'mood_great', label: 'Great', value: 5, color: '#10B981' }, notes: 'Morning walk helped a lot.' },
  { id: 'j4', date: new Date(Date.now() - 7*86400000).toISOString().split('T')[0], bp: '126/84', glucose: 111, weight: 72.5, mood: { icon: 'mood_low',   label: 'Low',   value: 2, color: '#FB923C' }, notes: 'Missed morning walk. Stressed.' },
];
