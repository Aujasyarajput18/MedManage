  ...
  return (
    <div style={{ maxWidth: 720, margin: '0 auto', padding: '40px 24px', color: 'var(--text-secondary)', lineHeight: 1.8 }}>
      ...
      {[
        ...
        { title: '3. AI queries', body: 'When you use the AI drug interaction checker, your medicine names are sent to the Claude API (by Anthropic) for analysis. We strip any personally identifiable information before sending. We also cache results in Firestore to minimize future API calls.' },
